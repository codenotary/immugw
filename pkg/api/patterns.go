...
var (
	...
	Pattern_ImmuService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{
		int(utilities.OpLitPush), 0,
		int(utilities.OpPush), 0,
		int(utilities.OpCapture), 1,
		int(utilities.OpLitPush), 2,
	...
	}, []string{"db", "databaseName", "get", "key"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	Pattern_ImmuService_Count_0 = runtime.MustPattern(runtime.NewPattern(1, []int{
		int(utilities.OpLitPush), 0,
		int(utilities.OpPush), 0,
		int(utilities.OpCapture), 1,
		int(utilities.OpLitPush), 2,
		...
		int(utilities.OpConcatN), 1,
		int(utilities.OpCapture), 3,
	}, []string{"db", "databaseName", "count", "prefix"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	Pattern_ImmuService_TxById_0 = runtime.MustPattern(runtime.NewPattern(1, []int{
		int(utilities.OpLitPush), 0,
		int(utilities.OpPush), 0,
		int(utilities.OpCapture), 1,
		int(utilities.OpLitPush), 2,
	...
	}, []string{"db", "databaseName", "tx"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	Pattern_ImmuService_CreateDatabaseV2_0 = runtime.MustPattern(runtime.NewPattern(1, []int{
		int(utilities.OpLitPush), 0,
		int(utilities.OpPush), 0,
		int(utilities.OpCapture), 1,
		int(utilities.OpLitPush), 2,
		int(utilities.OpLitPush), 3,
	}, []string{"db", "databaseName", "create", "v2"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	Pattern_ImmuService_DatabaseListV2_0 = runtime.MustPattern(runtime.NewPattern(1, []int{
		int(utilities.OpLitPush), 0,
		int(utilities.OpPush), 0,
		int(utilities.OpCapture), 1,
		int(utilities.OpLitPush), 2,
		int(utilities.OpLitPush), 3,
	}, []string{"db", "databaseName", "list", "v2"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	Pattern_ImmuService_UpdateDatabaseV2_0 = runtime.MustPattern(runtime.NewPattern(1, []int{
		int(utilities.OpLitPush), 0,
		int(utilities.OpPush), 0,
		int(utilities.OpCapture), 1,
		int(utilities.OpLitPush), 2,
		int(utilities.OpLitPush), 3,
	}, []string{"db", "databaseName", "update", "v2"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	Pattern_ImmuService_GetDatabaseSettingsV2_0 = runtime.MustPattern(runtime.NewPattern(1, []int{
		int(utilities.OpLitPush), 0,
		int(utilities.OpPush), 0,
		int(utilities.OpCapture), 1,
		int(utilities.OpLitPush), 2,
		int(utilities.OpLitPush), 3,
	}, []string{"db", "databaseName", "settings", "v2"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	Pattern_ImmuService_ListTables_0 = runtime.MustPattern(runtime.NewPattern(1, []int{
		int(utilities.OpLitPush), 0,
		int(utilities.OpPush), 0,
		int(utilities.OpCapture), 1,
		int(utilities.OpLitPush), 2,
		int(utilities.OpLitPush), 3,
	}, []string{"db", "databaseName", "table", "list"}, "", runtime.AssumeColonVerbOpt(true)))
